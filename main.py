...
from crecimiento_natural import crecimiento_bp  # Importa el Blueprint de Crecimiento Natural

app = Flask(__name__)
app.register_blueprint(mortalidad_bp)
app.register_blueprint(natalidad_bp)
app.register_blueprint(crecimiento_bp)  # Registra el Blueprint del Crecimiento Natural
